function [Config, MultiRunConfig, cs] = IEEE39BusAttackHaveAandCNoSE
...
MultiRunConfig.ConfigName = {'LoadShapeRatio','toBus'};
MultiRunConfig.ConfigValue = {linspace(1.4,1.5,6),1:29};
