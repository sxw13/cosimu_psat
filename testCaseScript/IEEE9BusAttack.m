...
FalseData.maxLearnedAction = 9;
FalseData.minAttackValue = 1;
...
MultiRunConfig.ConfigName = {'LoadShapeRatio','toBus','errorRatio','falseDataSchema'};
% MultiRunConfig.ConfigValue = {[0.5 0.75 1],1:9,linspace(0.5,2,6)};
MultiRunConfig.ConfigValue = {1.2,5,2,[2 0]};
